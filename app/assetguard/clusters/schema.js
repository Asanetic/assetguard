...
export const ClustersSchema = {
  entity: 'clusters',              // DB table name; also drives default role names
                                     // (view_clusters / manage_clusters) and apiBase
  label: 'Clusters',                 // optional, defaults to entity capitalized
  apiBase: '/api/assetguard/clusters',
  ...
  moduleRole: 'view_clusters',

  // Field keys shown as columns in list view, in display order.
  showInList: ['row_count', 'cluster_name', 'description', 'date_created'],
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/assetguard/clusters/list', grid: false, form: true },
    { key: 'save', label: 'Save', icon: 'save', variant: 'primary', grid: false, form: true, rowAction: false },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this cluster?', editOnly: true, grid: false, form: true, rowAction: true, role: 'manage_clusters' },
    { key: 'view', label: 'View more', icon: 'edit', rowAction: true },
    { key: 'new', label: 'New Cluster', icon: 'plus', variant: 'outline-primary', navigateTo: '/assetguard/clusters/profile', grid: false, form: false, rowAction: false },
    { key: 'new_cluster_from_grid', label: 'New Cluster', icon: 'plus', variant: 'outline-primary', type: 'action', grid: true, form: false, rowAction: false },
    { key: 'clone', label: 'Clone & Edit', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_clusters' },
  ...
  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 2, fields: ['cluster_name',"date_created"] },
    { key: 'other', label: 'Remark', columns: 1, fields: ['description'] },
  ],
  ...
  fields: [
    ...
    { key: 'cluster_name', label: 'Cluster Name', type: 'text', title: true, required: true, searchable: true },
    { key: 'description', label: 'Description', type: 'textarea', searchable: true },
    { key: 'date_created', label: 'Date Created', type: 'datetime', editable: false, computed:true },
  ...
  // roles: { view: 'view_clusters', manage: 'manage_clusters' },
};
