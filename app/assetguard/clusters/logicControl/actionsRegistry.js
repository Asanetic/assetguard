...
import ClustersProfile from "../uiControl/ClustersProfile";
...
const ClustersActions = {
  ...
  new_cluster_from_grid: async ({ schema, create, refresh }) => {
    MosyCard("New Cluster", <ClustersProfile onDone={refresh} hiddenActions= {["back"]}/>, true , "modal2","mosycard_medium");
  },
