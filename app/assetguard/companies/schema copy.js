...
export const CompaniesSchema = {
  ...
  rowLinks: [
    ...
    { key: 'activate_account', label: 'Activate Account', icon: 'check-circle', type: 'action' },
    { key: 'view_profile', label: 'View Profile', icon: 'user', type: 'action' },
  ],
  ...
  // CompaniesProfile.jsx) and the button set changes with zero template edits.
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/assetguard/companies' },
    { key: 'view_on_map', label: 'View on map', icon: 'map', variant: 'outline-secondary', editOnly: true },
    { key: 'activate_account', label: 'Activate', icon: 'check-circle', variant: 'outline-success', editOnly: true },
    ...
    { key: 'new', label: 'New Site', icon: 'plus', variant: 'dark', navigateTo: '/assetguard/companies/profile' },
  ],
  ...
  // Plain grouped-field layout (Symphony-style profile). Matches
  // RegisteredsitesProfile.jsx's section breakdown 1:1.
  sections: [
    {
      key: 'site_details',
      label: 'Site Details',
