...
const CompaniesActions = {
  ...
  register_company: async({ schema, create, refresh , onDone}) => {
    MosyCard("Register a Company", <CompaniesProfile onDone={onDone} hiddenActions={["register_company","back"]}/>, false, "modal2", "mosycard_wide");
  },
