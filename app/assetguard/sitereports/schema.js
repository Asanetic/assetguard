...
export const SitereportsSchema = {
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/assetguard/sitereports/list' },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this sitereport?', editOnly: true },
    { key: 'new', label: 'New Sitereport', icon: 'plus', variant: 'outline-danger', navigateTo: '/assetguard/sitereports/profile' },
  ...
  fields: [
    ...
    { key: 'status', label: 'Status', type: 'groupedSelect', endpoint: '/api/assetguard/sitereports', groupByField: 'status', searchable: true },
