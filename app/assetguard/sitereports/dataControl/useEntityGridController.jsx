...
// sitereports (table, card grid, kanban, whatever) calls this and gets back
...
//
// Sitereportss should contain markup only — no business logic. If a new
// sitereports needs a capability this hook doesn't expose yet, add it HERE,
// not in the sitereports, so every sitereports gets it for free.
//
// Usage:
