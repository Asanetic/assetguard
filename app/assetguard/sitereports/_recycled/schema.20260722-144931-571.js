...
export const SitereportsSchema = {
  entity: 'regions',              // DB table name; also drives default role names
                                     // (view_sitereports / manage_sitereports) and apiBase
  label: 'Sitereports',                 // optional, defaults to entity capitalized
  apiBase: '/api/assetguard/sitereports',
  ...
  // roles: { view: 'view_sitereports', manage: 'manage_sitereports' },
};
