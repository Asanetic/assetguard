...
export const MOSY_ACCESS_KEY = "MANAGE_DEVICE_LIST";
              ...
              <div className="col m-0 p-0 pb-3">
                
                {
                  device_listNode?.primkey ? (
                    ...
                    <span>{`Device List / ${device_listNode?.date_installed}`}</span>
                    
                  ) : customProfileData?.DeviceListTitle ? (
                    
                    <span>{customProfileData.DeviceListTitle}</span>
                    
                  ) : (
                    
                    <span>New Device List</span>
        ...
        <div className="row justify-content-center m-0 p-0 col-md-12" id="">
          ...
          <div className="col-md-12 row justify-content-center m-0  p-0">
            ...
            <div className="col-md-12 row p-0 justify-content-center p-0 m-0">
              <div className="col-md-12 bg-white border border_set shadow-md p-4 mb-4 hive_form_section  ">
                ...
                <div className="row justify-content-start col-md-12 p-0 m-0 ">
                  ...
                  field="registered_on"
                  label="Registered On"
                  value={device_listNode?.registered_on || ""}
                  onChange={handleInputChange}
                  context={{ hostParent: hostParent  }}
                  inputOverrides={{}}
                  type="datetime-local"
              ...
              <div className="col-md-12 bg-white border border_set shadow-md p-4 mb-4 hive_form_section  ">
                ...
                <div className="row justify-content-start col-md-12 p-0 m-0 ">
                  ...
                  field="site_name"
                  label="Site Name"
                  value={device_listNode?.site_name || ""}
                  onChange={handleInputChange}
                  context={{ hostParent: hostParent  }}
                  inputOverrides={{}}
                  type="text"
                  ...
                  field="created_at"
                  label="Created At"
                  value={device_listNode?.created_at || ""}
                  onChange={handleInputChange}
                  context={{ hostParent: hostParent  }}
                  inputOverrides={{}}
                  type="datetime-local"
                  ...
                  field="updated_at"
                  label="Updated At"
                  value={device_listNode?.updated_at || ""}
                  onChange={handleInputChange}
                  context={{ hostParent: hostParent  }}
                  inputOverrides={{}}
                  type="datetime-local"
            ...
            <section className="hive_control">
              <input type="hidden" id="device_list_dataNode" name="device_list_dataNode" value={paramDeviceListUptoken}/>
