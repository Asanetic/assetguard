...
export const MOSY_ACCESS_KEY = "VIEW_DEVICE_LIST";
...
export default function DeviceListList({ dataIn = {}, dataOut = {} }) {
  ...
  useEffect(() => {
    ...
    const customFilter = {
      ...
      ...customQueryStr,
      ...MosySecureFilterEngine("device_list"),
      
    }
    
    
    loadDeviceListListData(customFilter, stateItemSetters);
  ...
  function moduleFilterManager(action = "")
  {
    ...
    if(action === "search"){
      ...
      //set url params
      mosyFilterUrl({tableName:"device_list", keyword:stateItem.deviceListQuerySearchStr, reload:false})
    ...
    {
      //empty Search String
      stateItemSetters.setDeviceListQuerySearchStr("");
      ...
      deleteUrlParam("qdevice_list")
      deleteUrlParam("device_list_mosyfilter")
    ...
    <div className={`col-md-12  p-0 m-0  ${showDataControlSections && ("main_list_container")}  `} style={{marginTop: "0px", paddingBottom: "0px"}}>
      ...
      {showDataControlSections && (<div className="row justify-content-end col-md-12 text-right pt-3 pb-3 data_list_section ml-0 mr-0 mb-3 border-bottom pr-0 pl-0" id="">
        ...
        <div className="col-md-6 p-0 text-right hive_list_search_tray">
          ...
          />
          <button className="custom-search-botton" id="qdevice_list_btn" name="qdevice_list_btn" type="button" onClick={() => moduleFilterManager("search")}><i className="fa fa-search mr-1"></i> Go </button>
        </div>
        ...
        <div className="row justify-content-end m-0 p-0 col-md-12 hive_list_action_btn_tray" id="">
          ...
          <div className="col-md-12 p-0 hive_list_nav_right_ribbon" id="">
            ...
            <AddNewButton src="DeviceListList" link={customProfilePath} label="New Device List" icon="plus-circle" />
            <div
            ...
            return(
              <Fragment key={`_row_${listdevice_list_result.primkey}`}>
                <tr key={listdevice_list_result.primkey}>
                  <td>
                    ...
                    <td scope="col"><span title={listdevice_list_result.date_installed}>{mosyFormatDateTime(listdevice_list_result.date_installed)}</span></td>
                    ...
                    <td scope="col"><span title={listdevice_list_result.registered_on}>{mosyFormatDateTime(listdevice_list_result.registered_on)}</span></td>
                    <td scope="col"><span title={listdevice_list_result.geofence}>{magicTrimText(listdevice_list_result.geofence, 70)}</span></td>
                    <td scope="col"><span title={listdevice_list_result.site_id}>{magicTrimText(listdevice_list_result.site_id, 70)}</span></td>
              ...
              <tr><td colSpan="8" className="text-muted">
                ...
                <div className="col-md-12 text-center mt-4">
                  <h6 className="col-md-12 text-center p-3 mb-5 text-muted"><i className="fa fa-search"></i> Sorry, no device list records found</h6>
