...
// regionsreport (table, card grid, kanban, whatever) calls this and gets back
...
//
// RegionsReports should contain markup only — no business logic. If a new
// regionsreport needs a capability this hook doesn't expose yet, add it HERE,
// not in the regionsreport, so every regionsreport gets it for free.
//
// Usage:
