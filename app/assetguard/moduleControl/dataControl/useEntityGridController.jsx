...
export function useEntityGridController(schema, { fixedQuery = {}, title, description } = {}) {
  ...
  // Page-level gate — CompaniesGrid.jsx checks this before rendering
  // anything else. No moduleRole on the schema means open to anyone, same
  // additive convention as every other role/flag. Mirrors
  // useEntityFormController's identical accessDenied computation exactly
  // — this hook simply never had it, which is why the grid was showing
  // regardless of role while the profile page correctly gated.
  ...
  return {
    ...
    // Page-level gate — see accessDenied computation above.
    accessDenied,
