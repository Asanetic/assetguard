...
// Mirrors useEntityGridController: any UI regionmaster (DynamicForm, a modal,
...
// from schema.profileActions. The regionmaster never hardcodes a single
...
//   ))}
//
// Swap schema.profileActions and the SAME regionmaster renders a totally
// different button set — no regionmaster edits needed.
