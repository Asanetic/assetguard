...
// regionmaster (table, card grid, kanban, whatever) calls this and gets back
...
//
// Regionmasters should contain markup only — no business logic. If a new
// regionmaster needs a capability this hook doesn't expose yet, add it HERE,
// not in the regionmaster, so every regionmaster gets it for free.
//
// Usage:
