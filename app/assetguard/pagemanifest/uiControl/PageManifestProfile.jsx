              ...
              <div className="col m-0 p-0 pb-3">
                
                {
                  page_manifest_Node?.primkey ? (
                    ...
                    <span>{`Page Manifest  / ${page_manifest_Node?.page_group}`}</span>
            ...
            <div className="col-md-12 row p-0 justify-content-center p-0 m-0">
              <div className="col-md-12 bg-white border border_set shadow-md p-4 mb-4 hive_form_section  ">
                ...
                <div className="row justify-content-start col-md-12 p-0 m-0 ">
                  ...
                  field="manifest_key"
                  label="Manifest Key"
                  value={page_manifest_Node?.manifest_key || ""}
                  ...
                  field="project_id"
                  label="Project Id"
                  value={page_manifest_Node?.project_id || ""}
                  onChange={handleInputChange}
                  context={{ hostParent: hostParent  }}
                  inputOverrides={{}}
                  type="text"
                  ...
                  field="created_at"
                  label="Created At"
                  value={page_manifest_Node?.created_at || ""}
                  onChange={handleInputChange}
                  context={{ hostParent: hostParent  }}
                  inputOverrides={{}}
                  type="datetime-local"
              ...
              <div className="col-md-12 bg-white border border_set shadow-md p-4 mb-4 hive_form_section  ">
                ...
                <div className="row justify-content-start col-md-12 p-0 m-0 ">
                  ...
                  field="updated_at"
                  label="Updated At"
                  value={page_manifest_Node?.updated_at || ""}
                  onChange={handleInputChange}
                  context={{ hostParent: hostParent  }}
                  inputOverrides={{}}
                  type="datetime-local"
