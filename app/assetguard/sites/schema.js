...
import SiteLocationMap from './uiControl/SiteMapPicker';
...
export const SitesSchema = {
  ...
  customBlocks: [
    ...
    {key :"google_map_section", component: SiteLocationMap, colSpan: 12},
    {key :"coordinate_picker", component: CoordinatePicker, colSpan: 12},
    {key :"people_row_picker", component: SitePeopleRows, colSpan: 12},
    {key :"security_company_row_picker", component: SitePeopleRows, colSpan: 12},
    {key :"noc_company_row_picker", component: SitePeopleRows, colSpan: 12},
  ...
  sections: [
    { key: "google_map_section", label: "_", columns: 12, fields: ["google_map_section"] },
    ...
    { key: 'security_company_details', label: 'Security company details', columns: 3, fields: ['security_company', "vehicle_registration_number","region","security_company_row_picker"] },
    { key: 'noc_details', label: 'NOC details', columns: 2, fields: ["noc_company","noc_company_row_picker"] },
    { key: 'additional_alert_recipients', label: 'Additional alert recipients', columns: 1, fields: ["additional_sms_recipients","additional_email_recipients"] },
  ...
  fields: [
    ...
    { key: 'region', label: 'Region',
      type: 'liveSearch', colSpan: 4,
      endpoint:apiRoutes.clusters.base,
      searchTable: 'clusters',
      valueField: 'cluster_name',      // id column on system_modules
      displayField: 'cluster_name',  // label column on system_modules — what search results/defaultValue text actually render
      labelKey: 'region',  // cached label already joined onto THIS row (system_roles) — only used to seed defaultValue on load
    },
    { key: 'manager_mobile', label: 'Manager Mobile', type: 'text' },
    { key: 'manager_email', label: 'Manager Email', type: 'text' },
    { key: 'vehicle_registration_number', label: 'Car Number', type: 'text' },
    ...
    { key: 'additional_sms_recipients', label: 'Additional Sms Recipients (Comma separated)', type: 'textarea' },
    { key: 'additional_email_recipients', label: 'Additional Email Recipients (Comma separated)', type: 'textarea' },
    { key: 'last_inspection_date', label: 'Last Inspection Date', type: 'datetime' },
    { key: 'distribution_region', label: 'Distribution Region', type: 'text' },
