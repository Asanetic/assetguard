...
export const PaymentsSchema = {
  ...
  fields: [
    ...
    { key: 'supplier_id', label: 'Supplier Id', type: 'text', searchable: true },
    { key: 'vendor', label: 'Supplier ', type: 'text', searchable: true , computed: true},
    { key: 'amount_paid', label: 'Amount Paid', type: 'text', searchable: true, sum: true },
  ...
  batchMutations: {
    "vendor": {
      type: "join", table: "suppliers", link: "supplier_id:id",
      select: { "vendor": "supplier_name" }
    },
  },
