...
export const SuppliersSchema = {
  ...
  showInList: ['supplier_tel', 'category', 'row_count'],
  ...
  fields: [
    ...
    { key: 'supplier_tel', label: 'Supplier Tel', type: 'text', searchable: true },
  ...
  batchMutations: {
    "total_paid": {
      type: "sum", table: "payments", link: "supplier_id:id",column : "amount_paid",
      select: {}
    },
  },
