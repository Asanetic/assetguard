...
export const SitesreportSchema = {
  ...
  profileActions: [
    { key: 'back', label: 'Back to list', icon: 'arrow-left', variant: 'outline-secondary', navigateTo: '/assetguard/sitesreport/list' },
    { key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true },
    { key: 'delete', label: 'Delete', icon: 'trash', variant: 'outline-danger', confirm: 'Are you sure you want to delete this sitesreport?', editOnly: true },
    { key: 'new', label: 'New Sitesreport', icon: 'plus', variant: 'outline-danger', navigateTo: '/assetguard/sitesreport/profile' },
  ...
  fields: [
    ...
    { key: 'status', label: 'Status', type: 'groupedSelect', endpoint: '/api/assetguard/sitesreport', groupByField: 'status', searchable: true },
