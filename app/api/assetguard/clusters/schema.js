...
export const ClustersSchema = {
  ...
  showInList: ['row_count', 'cluster_name', 'description', 'date_created', 'hive_site_id', 'hive_site_name'],
  ...
  profileActions: [
    ...
    { key: 'new', label: 'New Cluster', icon: 'plus', variant: 'outline-primary', navigateTo: '/assetguard/clusters/profile', grid: true, form: false, rowAction: false },
    //{ key: 'clone', label: 'Clone Record', icon: 'copy', variant: 'outline-secondary', editOnly: true, grid: false, form: true, rowAction: false, role: 'manage_clusters' },
  ...
  sections: [
    { key: 'basic_information', label: 'Basic Information', columns: 3, fields: ['cluster_name', 'description', 'date_created', 'hive_site_id', 'hive_site_name'] },
  ],
  ...
  fields: [
    ...
    { key: 'description', label: 'Description', type: 'textarea', colSpan: 3, searchable: true },
