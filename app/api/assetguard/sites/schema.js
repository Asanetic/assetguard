...
export const SitesSchema = {
  ...
  showInList: ['site_name', 'site_code', 'country', 'city', 'county', 'town', 'latitude', 'row_count'],
  ...
  batchMutations: {
    ...
    // },
    "total_devices": {
      type: "count", table: "device_list", link: "site_id:record_id",
      select: { "total_devices": "full_name" }
    },    
  },
