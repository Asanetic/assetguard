...
//"primkey" , "record_id" , "log_type" , "site_name" , "device_id" , "battery_level" , "latitude" , "longitude" , "log_details" , "speed" , "remark" , "timestamp" , "created_on" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "gps_logs" => ["primkey","record_id","log_type","site_name","device_id","battery_level","latitude","longitude","log_details","speed","remark","timestamp","created_on","created_at","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "gps_logs" => [
              "Basic Information" => ["primkey","record_id","log_type","site_name","device_id","battery_level","latitude","longitude","log_details"]
          ]
      ...
      "print_tables" => merge_setting(["gps_logs"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["speed","remark","timestamp","created_on","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "datetime_columns" => merge_setting(["timestamp","created_at","updated_at"], "datetime_columns"),
      ...
      "new_label_buttons_arr" => merge_setting([
          "gps_logs" => "plus-circle:New Gps Logs:{`Gps Logs / \${gps_logsNode?.site_name}`}"
    ...
    "import"=>[
        ...
        "gps_logs"=>[
            ...
            "csv"=>"primkey,record_id,log_type,site_name,device_id,battery_level,latitude,longitude,log_details,speed,remark,timestamp,created_on,created_at,updated_at,hive_site_id,hive_site_name",
