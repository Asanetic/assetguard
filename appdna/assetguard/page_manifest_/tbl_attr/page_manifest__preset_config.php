...
//"primkey" , "record_id" , "manifest_key" , "page_group" , "site_id" , "page_url" , "project_id" , "project_name" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "page_manifest_" => ["primkey","record_id","manifest_key","page_group","site_id","page_url","project_id","project_name","created_at","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "page_manifest_" => [
              "Basic Information" => ["primkey","record_id","manifest_key","page_group","site_id","page_url","project_id","project_name","created_at"]
          ]
      ...
      "skip_cols_list" => merge_setting(["updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "new_label_buttons_arr" => merge_setting([
          "page_manifest_" => "plus-circle:New Page Manifest :{`Page Manifest  / \${page_manifest_Node?.page_group}`}"
    ...
    "import"=>[
        ...
        "page_manifest_"=>[
            ...
            "csv"=>"primkey,record_id,manifest_key,page_group,site_id,page_url,project_id,project_name,created_at,updated_at,hive_site_id,hive_site_name",
