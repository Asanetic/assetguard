...
//"primkey" , "record_id" , "bundle_id" , "bundle_name" , "role_id" , "role_name" , "remark" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "user_bundle_role_functions" => ["primkey","record_id","bundle_id","bundle_name","role_id","role_name","remark","created_at","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "user_bundle_role_functions" => [
              "Basic Information" => ["primkey","record_id","bundle_id","bundle_name","role_id","role_name","remark","created_at","updated_at"]
          ]
    ...
    "import"=>[
        ...
        "user_bundle_role_functions"=>[
            ...
            "csv"=>"primkey,record_id,bundle_id,bundle_name,role_id,role_name,remark,created_at,updated_at,hive_site_id,hive_site_name",
