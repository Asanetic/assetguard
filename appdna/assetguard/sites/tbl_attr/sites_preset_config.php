...
//"primkey" , "record_id" , "site_name" , "site_code" , "country" , "city" , "county" , "town" , "latitude" , "longitude" , "location_address" , "remark" , "created_on" , "manager" , "manager_mobile" , "manager_email" , "contact_person" , "contact_person_mobile" , "contact_person_email" , "company_security_manager" , "company_security_contacts" , "vendor_contact_person" , "vendor_contacts" , "response_team_contact_person" , "response_team_contacts" , "crew_commander_contact_person" , "crew_commander_contacts" , "vehicle_registration_number" , "alternate_phone_number" , "vendor" , "management_company" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  include("../appdna/assetguard/global_app_ui_presets.php");
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "sites" => ["primkey","record_id","site_name","site_code","country","city","county","town","latitude","longitude","location_address","remark","created_on","manager","manager_mobile","manager_email","contact_person","contact_person_mobile","contact_person_email","company_security_manager","company_security_contacts","vendor_contact_person","vendor_contacts","response_team_contact_person","response_team_contacts","crew_commander_contact_person","crew_commander_contacts","vehicle_registration_number","alternate_phone_number","vendor","management_company","created_at","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "sites" => [
              "Basic Information" => ["primkey","record_id","site_name","site_code","country","city","county","town","latitude"]
          ]
      ...
      "print_tables" => merge_setting(["sites"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["longitude","location_address","remark","created_on","manager","manager_mobile","manager_email","contact_person","contact_person_mobile","contact_person_email","company_security_manager","company_security_contacts","vendor_contact_person","vendor_contacts","response_team_contact_person","response_team_contacts","crew_commander_contact_person","crew_commander_contacts","vehicle_registration_number","alternate_phone_number","vendor","management_company","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "new_label_buttons_arr" => merge_setting([
          "sites" => "plus-circle:New Sites:{`Sites / \${sitesNode?.site_code}`}"
    ...
    "import"=>[
        ...
        "sites"=>[
            ...
            "csv"=>"primkey,record_id,site_name,site_code,country,city,county,town,latitude,longitude,location_address,remark,created_on,manager,manager_mobile,manager_email,contact_person,contact_person_mobile,contact_person_email,company_security_manager,company_security_contacts,vendor_contact_person,vendor_contacts,response_team_contact_person,response_team_contacts,crew_commander_contact_person,crew_commander_contacts,vehicle_registration_number,alternate_phone_number,vendor,management_company,created_at,updated_at,hive_site_id,hive_site_name",
