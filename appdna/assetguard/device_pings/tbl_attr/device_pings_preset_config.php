...
//"primkey" , "record_id" , "device_id" , "ping_time" , "signal_strength" , "battery_level" , "remark" , "status" , "created_on" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  // Core definitions
  // =========================
  $primary_table__="device_pings";
  $__page_title ="Device Pings";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"devicepings",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"devicepingslist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "device_pings" => ["primkey","record_id","device_id","ping_time","signal_strength","battery_level","remark","status","created_on","created_at","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "device_pings" => [
              "Basic Information" => ["primkey","record_id","device_id","ping_time","signal_strength","battery_level","remark","status","created_on"]
          ]
      ...
      "print_tables" => merge_setting(["device_pings"], "print_tables"),
      ...
      "datetime_columns" => merge_setting(["ping_time","created_at","updated_at"], "datetime_columns"),
      ...
      "rename_tables_array" => merge_setting([
          "device_pings" => "Device Pings"
      ], "rename_tables_array"),

      "new_label_buttons_arr" => merge_setting([
          "device_pings" => "plus-circle:New Device Pings:{`Device Pings / \${device_pingsNode?.ping_time}`}"
    ...
    "import"=>[
        ...
        "device_pings"=>[
            ...
            "csv"=>"primkey,record_id,device_id,ping_time,signal_strength,battery_level,remark,status,created_on,created_at,updated_at,hive_site_id,hive_site_name",
