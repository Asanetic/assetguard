...
//"primkey" , "record_id" , "device_name" , "date_installed" , "serial_number" , "remark" , "registered_on" , "geofence" , "site_id" , "site_name" , "low_battery_level" , "geofence_limit_distance" , "device_location" , "speed_alert_value" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  $core_module_configs_=[
    ...
    "table_alias" =>"devicelist",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"devicelistlist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "device_list" => ["primkey","record_id","device_name","date_installed","serial_number","remark","registered_on","geofence","site_id","site_name","low_battery_level","geofence_limit_distance","device_location","speed_alert_value","created_at","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "device_list" => [
              "Basic Information" => ["primkey","record_id","device_name","date_installed","serial_number","remark","registered_on","geofence","site_id"]
          ]
      ...
      "print_tables" => merge_setting(["device_list"], "print_tables"),
      ...
      "skip_cols_list" => merge_setting(["site_name","low_battery_level","geofence_limit_distance","device_location","speed_alert_value","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "datetime_columns" => merge_setting(["date_installed","created_at","updated_at"], "datetime_columns"),
      ...
      "new_label_buttons_arr" => merge_setting([
          "device_list" => "plus-circle:New Device List:{`Device List / \${device_listNode?.date_installed}`}"
    ...
    "import"=>[
        ...
        "device_list"=>[
            ...
            "csv"=>"primkey,record_id,device_name,date_installed,serial_number,remark,registered_on,geofence,site_id,site_name,low_battery_level,geofence_limit_distance,device_location,speed_alert_value,created_at,updated_at,hive_site_id,hive_site_name",
