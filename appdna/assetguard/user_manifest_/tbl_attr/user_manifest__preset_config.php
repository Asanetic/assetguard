...
//"primkey" , "record_id" , "admin_manifest_key" , "user_id" , "user_name" , "role_id" , "site_id" , "role_name" , "project_id" , "project_name" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
      ...
      "desired_column_order" => merge_setting([
          "user_manifest_" => ["primkey","record_id","admin_manifest_key","user_id","user_name","role_id","site_id","role_name","project_id","project_name","created_at","updated_at","hive_site_id","hive_site_name"]
      ], "desired_column_order"),

      "form_input_segmentation_arr" => merge_setting([
          "user_manifest_" => [
              "Basic Information" => ["primkey","record_id","admin_manifest_key","user_id","user_name","role_id","site_id","role_name","project_id"]
          ]
      ...
      "skip_cols_list" => merge_setting(["project_name","created_at","updated_at","hive_site_id","hive_site_name"], "skip_cols_list"),
      ...
      "new_label_buttons_arr" => merge_setting([
          "user_manifest_" => "plus-circle:New User Manifest :{`User Manifest  / \${user_manifest_Node?.user_id}`}"
    ...
    "import"=>[
        ...
        "user_manifest_"=>[
            ...
            "csv"=>"primkey,record_id,admin_manifest_key,user_id,user_name,role_id,site_id,role_name,project_id,project_name,created_at,updated_at,hive_site_id,hive_site_name",
